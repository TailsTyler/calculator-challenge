...
#how to do wo popping twice?
def move_stacks_9001_style(stacks, array_of_3_number_arrays): #move 3 from 1 to 2
    for command in array_of_3_number_arrays:
        temp_stack = []
        for num_to_move in range(command[0]):
            temp_stack.append(stacks[command[1] - 1].pop())
        for num_to_move in range(command[0]):
            stacks[command[2] - 1].append(temp_stack.pop())
    return stacks
...
print(str(floor_line) + ": floor line")
num_of_stacks = get_num_of_stacks(file, floor_line)
print(str(num_of_stacks) + ": num of stacks")
...
print("\narray_of_3_number_arrays:\n" + str(array_of_3_number_arrays))
stacks_after_movement = move_stacks_9001_style(stacks, array_of_3_number_arrays)
print("\nstacks_after_movement:\n" + str(stacks_after_movement))
