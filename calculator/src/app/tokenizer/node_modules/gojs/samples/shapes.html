...
<div id="sample">
  ...
  <p>
    A number of very common figures are predefined in go.js: <code>"Rectangle", "Square", "RoundedRectangle", "Border", "Ellipse", "Circle",
      "TriangleRight","TriangleDown", "TriangleLeft", "TriangleUp", "Triangle", "Diamond", "LineH", "LineV", "BarH", "BarV",
      "MinusLine", "PlusLine", "XLine", "LineRight", "LineDown", "LineLeft", "LineUp"</code>.
